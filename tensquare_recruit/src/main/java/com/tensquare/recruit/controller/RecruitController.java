...
public class RecruitController {
	...
	@RequestMapping(value = "search/recommend1",method = RequestMethod.GET)
	public Result recommend1(){
		List<Recruit> list = recruitService.recommend1();
		return new Result(true, StatusCode.OK, "selected is OK ", list);
	}
